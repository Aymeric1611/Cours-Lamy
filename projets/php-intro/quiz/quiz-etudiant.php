...
echo "========================================\n
    BIENVENUE DANS LE QUIZ BTS SIO\n
========================================\n";
/*
$i = 0;
$bonneReponse = 0;
foreach ($questions as $question){
    ...
    $reponse = readline("votre réponse(1-4) : ");
    ...
    if ($reponse == $t[5]){
        ...
        $indice = $t[5];
        echo "Mauvaise réponse ... La bonne était la $indice (".$t[$indice].")\n";
    }
    echo "----------------------------------------\n";
}

echo "========================================\n
TERMINE ! Votre score final : ". $bonneReponse. " / 20\n
Validation acquise. Continuez vos efforts !\n
======================================== ";
*/
...
foreach ($questions as $question){
    ...
    $i ++;
    $indice = $t[5];
    $reponse = $reponsesUtilisateur[$i-1];
    if ($reponse == $t[5]){
        echo "✅ Question $i : Bonne réponse !\n";
        $bonneReponse ++;
    } else {
        echo "❌ Question $i : Vous avez répondu $reponse mais la bonne réponse était $indice (".$t[$indice].")\n";
    }
}

if ($bonneReponse >= 10){
    echo "========================================\n
Votre score final : ". $bonneReponse. " / 20\n
Validation acquise. Continuez vos efforts !\n
======================================== ";
} else {
    echo "========================================\n
Votre score final : ". $bonneReponse. " / 20\n
Validation non-acquise. Continuez vos efforts !\n
======================================== ";
}
?>